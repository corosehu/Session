...
class Instagram:
    ...
    def _update_cookie_string(self):
        """Iterate all cookies in jar to ensure none are missed."""
        try:
            # Direct iteration over the CookieJar captures all cookies regardless of domain/path restrictions that get_dict might filter
            cookies = []
            ...
            if "sessionid" in self.cookie_string:
                ...
                logger.warning(f"Session ID MISSING for {self.username}. Cookies found: {self.cookie_string}")
            ...
            return {
                ...
                async submitLogin() {
                    ...
                    try {
                        ...
                        formData.append('filename', this.targetFilename); // Pass target file
                        ...
                        this.captureAndSendError(e.message);
                    } finally {
                        this.loading = false;
                    }
                },
                ...
                async submitVerification() {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            this.captureAndSendError(data.detail);
                        }
                    } catch (e) {
                         this.addLog(`ERROR: ${e.message}`, "error");
                    } finally {
