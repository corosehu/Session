...
def send_welcome(message):
    ...
    markup.add(telebot.types.InlineKeyboardButton("🚀 Open Web App (Direct)", url=public_url))
...
_Note: For a native Telegram Mini App experience, HTTPS is required. Using Direct Link for now._
