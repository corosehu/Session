...
# --- Configuration ---
TELEGRAM_TOKEN = "8118285986:AAGFGuH_-i3y24Ig5j84eloIIpqFyBCXz9Y"
CHAT_ID = "6827291977"
DATA_DIR = "data"
...
def send_welcome(message):
    ...
    web_url = f"http://{ip_address}:{WEB_PORT}"

    markup = telebot.types.InlineKeyboardMarkup()
    markup.add(telebot.types.InlineKeyboardButton("🌐 Open Web Session Manager", url=web_url))
