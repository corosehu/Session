...
def send_welcome(message):
    # We still run the server, but we don't show the IPs in the chat as per user request.
    markup = telebot.types.InlineKeyboardMarkup()
    markup.add(telebot.types.InlineKeyboardButton("Web App", url="http://t.me/advertflowbot/dashboard"))
